...
#
# also on floor 1: elerium and dilithium generators and microchips
ELEMENTS = [:elerium, :dilithium, :promethium, :cobalt, :curium, :ruthenium, :plutonium]
